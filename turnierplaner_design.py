...
class TeamErstellen(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        self.label_welc.grid(row=0, column=0, padx=30, pady=(30,10), sticky="ew", columnspan=2)

        self.header_button = ctk.CTkSegmentedButton(self, values=["Team", "Gruppe"])
        self.header_button.grid(row=1, column=0, padx=50, pady=(10, 0), sticky="ew", columnspan=2)

        self.weiteres_team_btn = ctk.CTkButton(self, text="Lade Turnier", command=self.weiteres_team)
        self.weiteres_team_btn.grid(row=3, column=0, padx=30, pady=(0, 30), sticky="n")
    ...
    def weiteres_team(self):
        ...
        self.entry_name_t = ctk.CTkEntry(self, width=50)
        self.entry_name_t.grid(row=self.team_row, column=0, padx=(50,0), pady=0, sticky="ew")
        self.entry_name_g = ctk.CTkEntry(self, width=50)
        self.entry_name_g.grid(row=self.team_row, column=0, padx=(0,50), pady=0, sticky="ew")
